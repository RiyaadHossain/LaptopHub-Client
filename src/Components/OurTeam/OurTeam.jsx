  ...
  return (
    <div className="bg-black py-16">
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 mt-6">
        <div>
          <img className="w-44" src={Microsoft} alt="" />
        </div>
        <div>
          <img className="w-44" src={Google} alt="" />
        </div>
        <div>
          <img className="w-44" src={Meta} alt="" />
        </div>
        <div>
          <img className="w-44" src={Motorolla} alt="" />
        </div>
        <div>
          <img className="w-44" src={Huawei} alt="" />
        </div>
        <div>
          <img className="w-44" src={Lenovo} alt="" />
        </div>
      </div>
    </div>
  );
